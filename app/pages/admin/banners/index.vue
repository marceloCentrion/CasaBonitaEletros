              ...
              <div class="row">
                ...
                <div class="col-2">
                  <div style="text-align: right">
                    <NuxtLink class="no-link" to="/admin/banners/criar-banner">
                      <AdminButton> Novo Banner </AdminButton>
                    </NuxtLink>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    <tr v-for="banner in state.banners" :key="banner.id">
                      ...
                      <td>
                        ...
                        <button
                          title="Deletar"
                          @click="abrirModalDeletar(banner.id, banner.nome)"
      ...
      <Transition name="modal-slide">
        ...
        >
          ...
          <div class="modal-confirm__body">
            <p>Tem certeza que deseja deletar o banner:</p>
            <strong>{{ state.bannerNomeParaDeletar }}</strong>
...
export default {
  setup() {
    useHead({
      title: "Casa Bonita Eletros - Banners",
    });
    ...
    const state = reactive({
      ...
      isLoading: false,
      modalDeletar: false,
      bannerIdParaDeletar: null,
      bannerNomeParaDeletar: "",
    });
    onMounted(() => {
      fetchBanner();
    });
    ...
    function fecharModalDeletar() {
      ...
      state.bannerIdParaDeletar = null;
      state.bannerNomeParaDeletar = "";
    }
    ...
    async function deletarBanner() {
      try {
        ...
        toast.error(error.response?.data?.msg || "Erro ao deletar banner.");
        console.log(error);
      } finally {
