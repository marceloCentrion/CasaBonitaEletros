      ...
      <div class="row">
        <div class="col-md-10 offset-md-1 mt-9">
          ...
          <div class="text-right mb-6">
            <a href="/minha-conta">
              <button class="btn_transparent">Voltar</button></a>
            <button @click="saveEndereco()" class="btn_gold">Continuar</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  setup() {
    ...
    if (router.currentRoute._value.params.novo != undefined) {
      state.novo = router.currentRoute._value.params.novo;
    } 
