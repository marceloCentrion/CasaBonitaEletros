      ...
      <div class="row">
        <div class="col-md-4 col-lg-3">
          ...
          <div class="quad_filtro">
            ...
            <div class="accordion" id="accordionExample">
              <div class="accordion-item" v-for="(grupo, i) in state.grupos" :key="grupo.id">
                <h2 class="accordion-header">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    :data-bs-target="'#collapseOne' + i" :class="{
                ...
                <div :id="'collapseOne' + i" class="accordion-collapse collapse"
                  :class="{ show: grupo.urn == state.grupo_urn }" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <ul>
                      <li v-for="categoria in grupo.categorias" :key="categoria.id">
                        <a class="a-bread" @click="produtosPorCategoria(categoria.urn)">{{ categoria.nome }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="col-md-8 col-lg-9">
          <div class="py-md-5">
            ...
            <div class="row">
              <div class="col-6 col-lg-4 offset-lg-0 py-2" v-for="produto in state.produtos" :key="produto.id">
...
export default {
  setup() {
    ...
    async function produtos(busca) {
      console.log(busca);
      state.loader = true;
      state.busca = busca;

      const { data } = await services.produtos.buscarProduto(busca);
      state.produtos = data;
      var qtd = state.produtos;
      state.qtd = qtd.length;
