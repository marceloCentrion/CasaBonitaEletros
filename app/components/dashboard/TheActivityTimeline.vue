        ...
        <div class="sl-item mt-2 mb-3">
          ...
          <div class="sl-right">
            <div>
              ...
              <a href="/" class="text-decoration-none mr-3 text-primary"><v-icon icon="$message" /> comments</a>
              <a href="/" class="text-decoration-none text-red"><v-icon icon="$heart" /> 5 Likes</a>
            </div>
          </div>
        </div>
        <v-divider></v-divider>
